...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget getHomePage() {
    ...
    homeWidgets.add(
        getResultOverview(_breachList?.length ?? 0, _pasteList?.length ?? 0));
    ...
    homeWidgets.add(Center(
      ...
      child: FlatButton(
        ...
        onPressed: () =>
            launchURL(context, "https://haveibeenpwned.com/NotifyMe"),
      ),
    )));
  ...
  Widget getResultOverviewSubHeading(int breachCount, int pasteCount) {
    ...
    String pwnedText =
        "Pwned on $breachCount breached ${breachCount > 1 ? "sites" : "site"}";
    String andPasteText =
        " and found $pasteCount ${breachCount > 1 ? "pastes" : "paste"}";
    String pasteText = "Found $pasteCount pastes";

    if (breachCount > 0) {
      return ResultSubTitle(
          pasteCount > 0 ? pwnedText + andPasteText : pwnedText);
      ...
      return Container(
        ...
        child: Card(
          ...
          title: Row(
            children: <Widget>[
              Container(
                child: getLogoImage(breach.logoPath),
                width: 60.0,
                height: 60.0,
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              child: Text(paste.date?.toString() ?? "",
                                  style: TextStyle(
  ...
  Widget getLogoImage(String logoPath) {
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(
                        ...
                        recognizer: TapGestureRecognizer()
                          ..onTap = () {
                            launchURL(context,
                                "https://github.com/callingmedic911/pwned_or_not");
                          }),
                    TextSpan(
                      text: ".",
                    ),
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(
                        ...
                        recognizer: TapGestureRecognizer()
                          ..onTap = () {
                            launchURL(
                                context, "https://haveibeenpwned.com/API/v2");
                          }),
                    TextSpan(
                      text: ".",
                    ),
                    ...
                    decoration: new BoxDecoration(
                      ...
                      image: new DecorationImage(
                        ...
                        image: new CachedNetworkImageProvider(
                            "https://twitter.com/troyhunt/profile_image?size=original"),
                      ),
                    ),
                  ),
                  Expanded(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          RaisedButton(
                              ...
                              child: Text("@troyhunt"),
                              onPressed: () => launchURL(
                                  context, "https://twitter.com/troyhunt"),
                  ...
                  Container(
                    ...
                    decoration: new BoxDecoration(
                      ...
                      image: new DecorationImage(
                        fit: BoxFit.fill,
                        image: new CachedNetworkImageProvider(
                            "https://twitter.com/callingmedic911/profile_image?size=original"),
                      ),
                    ),
                  ),
                  Expanded(
                        ...
                        children: <Widget>[
                          ...
                          RaisedButton(
                              ...
                              onPressed: () => launchURL(context,
                                  "https://twitter.com/callingmedic911"),
                              shape: RoundedRectangleBorder(
                                  borderRadius:
                                      new BorderRadius.circular(30.0))),
                        ],
